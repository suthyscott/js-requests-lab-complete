...
const helloBtn = document.querySelector('#say-hello-button')
...
function changeBackground(){
    ...
    helloBtn.style.backgroundColor = 'black'
}

helloBtn.addEventListener('mouseover', () => {
    changeBackground()
})
...
function backgroundBack(){
    helloBtn.style.color = 'black'
    helloBtn.style.backgroundColor = '#EFEFEF'
}

helloBtn.addEventListener('mouseout', () => {
    backgroundBack()
})
...
const repeatMyParam = () => {
    axios.get(`http://localhost:3000/repeat/why-hello`)
        .then(res => {
            console.log(res.data)
...
function makeRequest(){
    axios.get(`http://localhost:3000/query-test?favorite-bike=yamaha-xsr&favorite-car=bmw`)
        .then(res => {
            console.log(res.data)
        })
}
...
queryBtn.addEventListener('click', makeRequest)
